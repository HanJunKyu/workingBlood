						...
						<div class="loacation_wrap">
			               <nav class="location">
			                  <ul>
			                     ...
			                     <li class="list"><a href="">&gt;&nbsp;&nbsp;</a>감동 후기 글 수정하기</li>                     
			                  </ul>
			               </nav>
			            </div>
					</header>
				<form action="${pageContext.request.contextPath}/community_Review_Board/Review_BoardModifyOk.co" name="writeForm" method="post" enctype="multipart/form-data">
					<%-- 컨트롤러에 넘기기 위한 보드번호) --%>
	                ...
	                <div class="table-wrapper">
		                	...
		                	<table>
								<tbody>
			                        ...
			                        <tr>
			                        <td>제목</td>
			                        <td><input type = text name="board_title" id="board_title" size=60 value="${board.getBoard_title()}"></td>
			                        </tr>
			 
			                        <tr>
			                        <td>내용</td>
			                        <td><textarea name="board_content" id="board_content" cols=85 rows=15 placeholder="양식에 맞게 내용을 작성해주세요">${board.getBoard_content()}</textarea></td>
			                        </tr>
			                        ...
			                        <tr>
			                       	...
			                       	<td class="files" style="background-color: #fff;">
										<label for="board_file1" style="display:inline;">
											<c:choose>
												<%-- 대표사진을 설정하지 않았을 경우 --%>
												<c:when test="${board.getBoard_img_name() eq 'iconNoimg.png'}">
												...
												<%-- 대표사진을 설정했을 경우 --%>
												<c:otherwise>
												<img id="board_img_nameImg" src="${pageContext.request.contextPath}/upload/${board.getBoard_img_name()}" accept="image/*" width="100px" height="100px" style="display:block;margin-bottom: inherit;">
												</c:otherwise>
											</c:choose>
										</label>
										...
										<p style="margin:0em; font-size:smaller; color:gray;">※ 감동후기 게시판의 대표사진으로 올라갈 사진입니다. 사진을 선택하지 않을 경우 프로필 이미지로 올라갑니다.</p>
									</td>                       
			                       </tr>
              						<%-- 
				                       	...
				                       	<c:forEach var="file" items="${files}">
				                       		<c:choose>
												...
												<c:otherwise>
				                       		 	<td class="files" style="background-color: #fff;">
													<label for="board_file1" style="display:inline;">
														<img id="file1Img" src="${pageContext.request.contextPath}/upload/${file.getFile_name_original()}" width="60px" height="60px" style="display:block;margin-bottom: inherit;">
													</label>
				  ...
				  <section>
						<div class="col-12">
							<ul class="actions">
								<li><input type="submit" value="등록" class="primary" onclick="writeForm.submit()"/></li>
							</ul>
						</div>	
				  </section>	
