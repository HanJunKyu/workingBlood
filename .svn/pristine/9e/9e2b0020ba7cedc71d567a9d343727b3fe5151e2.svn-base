...
<body class="is-preload" style="background: #fff;">
	...
	<section style="border: 1px solid darkgrey;">
		<div class="inner">
			<h2 style="margin-bottom: 20%;">비밀번호 찾기</h2>
			<p style="font-size: 0.8em; text-align: center;">가입 당시 입력한 이메일 주소로 임시 비밀번호를 발송합니다.</p>
				<form method="post" action="${pageContext.request.contextPath}/user/FindPwSuccess.us" name="findForm">
					<table>
						<tr style="border: none;">
							<td colspan="2"><input type="text" name="user_id" id="user_id" value="" placeholder="아이디" /></td>							
						</tr>
						<tr style="border: none;">
							<td><input type="text" name="user_email" id="user_email" value="" placeholder="이메일" /></td>
							<td><input type="button" value="인증번호 발송" style="height: 44px;" onclick="sendSMS()"></td>
						</tr>
						<tr style="border: none;">
							<td><input type="text" name="user_email_check" id="user_email_check" value="" placeholder="인증번호" /></td>
	...
	<script src="${pageContext.request.contextPath}/app/user/find_pw_email.js"></script>
</body>
</html>