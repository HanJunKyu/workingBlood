...
<body class="is-preload" style="background: #fff;">
	...
	<section style="border: 1px solid darkgrey;">
		<div class="inner">
			...
			<p style="font-size: 0.8em; text-align: center;">가입 당시 입력한 이메일 주소로 아이디를 발송합니다.</p>
				<form method="post" action="${pageContext.request.contextPath}/user/FindIdEmailSuccess.us" name="findForm">
					<table>
	...
	<script src="${pageContext.request.contextPath}/app/user/find_email.js"></script>
</body>
</html>