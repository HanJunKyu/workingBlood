			...
			<p style="font-size: 0.8em; text-align: center;"></p>
					...
					<c:choose>
						...
						<tr style="height: 62px; border: none;">
							<td style="height: 100%; vertical-align: middle; border: 1px solid; font-size: 1.3em;">아이디 : ${userList.getUser_id()}</td>
						</tr>
						</c:forEach>
						</c:when>
						<c:otherwise>
						<tr style="height: 62px; border: none;">
							<td style="height: 100%; vertical-align: middle; border: 1px solid; font-size: 1.3em;">등록된 아이디가 없습니다.</td>
						</tr>	
						</c:otherwise>
						</c:choose>
